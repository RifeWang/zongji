...
BinlogEvent.prototype.dump = function() {
  ...
  return {
    action: this.getTypeName(),
    database: this.tableMap[this.tableId].parentSchema,
    table: this.tableMap[this.tableId].tableName,
    rows: this.rows
  }
};
...
Rotate.prototype.dump = function() {
  ...
  return {
    ...
    NextBinlogFile: this.binlogName
  }
};
...
TableMap.prototype.dump = function() {
  const result = BinlogEvent.prototype.dump.apply(this);
